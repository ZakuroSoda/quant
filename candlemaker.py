...
def candle_maker(df_working):
    ...
    # make the yrange random and dynamic so that while backtesting, we are not biased by the axis
    # yrange = [y_min - y_range * random.uniform(0.2, 0.5), y_max + y_range * random.uniform(0.2, 0.5)]
